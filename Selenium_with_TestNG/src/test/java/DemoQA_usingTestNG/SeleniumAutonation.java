...
public class SeleniumAutonation {

		WebDriverWait wait;
		WebDriver driver;

		@BeforeTest (description = "Get Domain Title", groups = "Setup")
...
//	        driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(5));
		...
		@Test(description = "Get Domain Title", groups = "Setup domain", priority = 1)
		...
		@Test(description = "Check banner Image")
		public void CheckImage() throws InterruptedException {
			...
			AssertJUnit.assertTrue(bannerImageExists);
			Thread.sleep(1000);
		}

		@Test(description = "Fillup Text boxes using my details")
		public void submitInputForm() throws InterruptedException {
...
//			System.out.println(getText);
		...
		@Test(description = "Muliple Button Click")
		public void clickOnMultipleButon() throws InterruptedException {
			...
			Assert.assertTrue(buttonText.contains("You have done a double click"));
			...
			Assert.assertTrue(buttonText2.contains("You have done a right click"));
			
			buttonlist.get(3).click();
			String buttonText3 = driver.findElement(By.id("dynamicClickMessage")).getText();
			Assert.assertTrue(buttonText3.contains("You have done a dynamic click"));
			System.out.println(buttonText3);
			Thread.sleep(1000);
		}

		@Test(description = "Alert Button Handling")
...
//	        driver.switchTo().alert().dismiss();
			...
			Assert.assertTrue(promtAlert.contains("Tarikul Nayeem"));
			Thread.sleep(1000);
		}
		
		@Test(description = "Date Picker from Keyboard")
		public void selectDatebySendKeys() throws InterruptedException {
...
//			Use Keys.chord(Keys.CONTROL, "a") for selecting all text properly.      //   (Keys.CONTROL + "A")
		...
		@Test(description = "Select Current date")
		public void gettingCurrentDateAndPasteInTheEditableField() throws InterruptedException {
			driver.get("https://demoqa.com/date-picker");
//			driver.findElement(By.id("datePickerMonthYearInput")).click();
...
//		}
		...
		@Test(description = "Select date from Dropdown")
...
//		    System.out.println(datePickerTextElement.getText());
		...
		@Test(description = "Select date & time from Dropdown")
...
//			driver.findElement(By.className("react-datepicker__month-read-view--selected-month")).click();
		...
		@Test(description = "Select Dropdown")
...
//			driver.findElement(By.id("withOptGroup")).sendKeys("Group 2, option 1");
		...
		@Test(description = "Window handling")
...
//			driver.switchTo().window(mainWindowHandle);
	    ...
	    void extractNameAndSalary() throws InterruptedException {
		...
		@Test(description = "Handling Frame")
		public void handleIframe() throws InterruptedException {
			...
			String text = driver.findElement(By.id("sampleHeading")).getText();
			AssertJUnit.assertTrue(text.contains("This is a sample page"));
			Thread.sleep(1000);
			}
